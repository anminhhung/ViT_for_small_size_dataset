...
def main(args):
    ...
    transformed_train_data = OOD_Dataset(label_path="train_labels.csv", root_dir="train", transform=augmentations)
    transformed_val_data = OOD_Dataset(label_path="val_labels.csv", root_dir="train", transform=augmentations)
    
    train_loader = DataLoader(transformed_train_data, batch_size=args.batch_size, shuffle=True, drop_last=True)
    val_loader = DataLoader(transformed_val_data, batch_size=args.batch_size)
